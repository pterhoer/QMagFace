...
import cv2
import numpy as np
from utils.files import path_join, convert_backslashes
...
def align_images(list_of_filenames, src_path_prefix, dst_path_prefix, filename_conversion_func=str):
    """
    ...
    :param list_of_filenames: a list of filenames which should be processed.
