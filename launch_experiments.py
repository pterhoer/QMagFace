...
@click.option('-r', '--dataset_root', default='_data/single_images/magface100', type=click.Path(exists=True), help='The directory where the embeddings and filenames files are saved.')
